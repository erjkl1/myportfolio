		  ...
		  <div>
			  ...
			  <div className="flex justify-center">
				  <div className="w-2/5 mr-20">
					  ...
					  <div className="flex justify-center">
						  <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/Chuke_yamaha">
							  <TwitterIcon sx={{ fontSize: 30 }} />
						  </a>
						  <a target="_blank" rel="noopener noreferrer" href="https://chuke-blog.com/" >
